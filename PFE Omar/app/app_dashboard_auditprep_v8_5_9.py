# ============================================================
# AuditPrep IA - V8.5.9 — interface Violet / Lavender / Soft Pink — Inter
# Base : V8.4 sécurisée + interface portail métier Convergence
# Fichier à placer dans : C:\PFE Omar\app\app_dashboard_auditprep_v8_5_9.py
#
# Lancement PowerShell :
#   cd "C:\PFE Omar"
#   conda run -n auditprep python -m streamlit run "app\app_dashboard_auditprep_v8_5_9.py"
# ============================================================
...
# ============================================================
# 2B. THÈME VISUEL FINAL INTÉGRÉ — V8.5.9 / INTER
...
/* Primary actions use the V8.5.9 violet palette, overriding legacy orange/red selectors */
.stButton > button[kind="primary"],
...
/* =========================================================
   V8.5.9 — GLASS DARK FIGMA-INSPIRED THEME
...
/* =========================================================
   V8.5.9 — READABILITY / CONTRAST PATCH
...
<div class="audit-user-chip">
    ...
    st.markdown(
    """
- Dashboard : **V8.5.9 interface #7D4FFE / #C49FFF / #FFD0E6 / Inter**
- Moteur SQL : **V6**
...
- Données : **validation experte + nettoyage du français**
...
st.markdown(
    """
<div class="audit-note">
<b>Lecture projet :</b> V8.3 améliore la lisibilité des lots,
