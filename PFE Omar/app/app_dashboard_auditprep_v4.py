...
============================================================
PROJET : AuditPrep IA
FICHIER : app_dashboard_auditprep_v4.py
VERSION : Dashboard Streamlit V4 - Démonstration métier & multi-mission
...
st.set_page_config(
    page_title="AuditPrep IA – Dashboard V4",
    page_icon="🧭",
    layout="wide",
...
st.markdown(
    ...
    <style>
        ...
        .flow-step {
            ...
            padding: 0 0.6rem;
            border-radius: 999px;
            background: rgba(184,54,54,0.13);
            font-weight: 840;
            margin-bottom: 0.48rem;
        }
        ...
        .demo-banner {
            border-radius: 20px;
            border: 1px solid rgba(78, 88, 108, 0.14);
            background: linear-gradient(135deg, rgba(247,248,252,0.96), rgba(236,240,246,0.98));
            padding: 1rem 1.2rem;
            margin-top: 0.45rem;
...
/* Badges de priorité */
.pill-high {
    background: rgba(184,54,54,0.15) !important;
    color: #8B1E1E !important;
}

.pill-medium {
    background: rgba(186,128,28,0.16) !important;
    color: #8A5A00 !important;
}

.pill-low {
    background: rgba(49,123,87,0.16) !important;
    color: #20613E !important;
}

/* ============================================================
   MODE SOMBRE : correction texte blanc sur fond trop clair
   ============================================================ */
...
@media (prefers-color-scheme: dark) {
    ...
    /* Toutes les cartes en mode sombre */
    .hero-box,
    .panel-box,
    .mission-box,
    .story-card,
    ...
    /* Textes secondaires en mode sombre */
    .hero-subtitle,
    .section-caption,
    .small-muted,
    .story-body,
    ...
    /* Numéros dans les cartes de flux */
    .flow-step {
        background: rgba(255,75,75,0.20) !important;
        color: #ffffff !important;
    }

    /* Badges priorité en mode sombre */
    .pill-high {
        background: rgba(255,75,75,0.20) !important;
...
st.sidebar.markdown("- Dashboard : **V4 démonstration métier**\n- Moteur SQL : **V6 multi-mission**")
st.sidebar.markdown(
    '<div class="sidebar-note">Le moteur illustre le passage métier : historique d’audit → score de vigilance → check-list priorisée.</div>',
    unsafe_allow_html=True,
)
...
st.markdown(
    """
    <div class="hero-box">
        <div class="hero-title">AuditPrep IA – Transformer l’historique d’audit en préparation intelligente</div>
        <div class="hero-subtitle">
            Prototype décisionnel multi-mission : un historique d’audit alimente un score de vigilance,
            puis le moteur génère automatiquement une check-list de préparation priorisée, traçable et exportable.
        </div>
    </div>
    """,
    unsafe_allow_html=True,
...
st.markdown('<div class="story-grid-title">Pourquoi cet outil ?</div>', unsafe_allow_html=True)
...
with story_col_1:
    st.markdown(
        ...
        <div class="story-card">
            <div class="story-kicker">Problème métier</div>
            <div class="story-title">La préparation d’audit reste trop manuelle</div>
            <div class="story-body">
                Les constats des audits passés sont souvent disponibles, mais peu réutilisés
                pour orienter efficacement les audits suivants.
            </div>
        </div>
        """,
        unsafe_allow_html=True,
...
with story_col_2:
    st.markdown(
        """
        <div class="story-card">
            <div class="story-kicker">Réponse AuditPrep IA</div>
            <div class="story-title">Capitaliser les signaux réellement utiles</div>
            <div class="story-body">
                Le moteur transforme les constats historiques en scores de vigilance
                par processus et par clause ISO, puis en priorités d’investigation.
            </div>
        </div>
        """,
        unsafe_allow_html=True,
...
with story_col_3:
    st.markdown(
        """
        <div class="story-card">
            <div class="story-kicker">Résultat attendu</div>
            <div class="story-title">Une préparation plus ciblée et plus explicable</div>
            <div class="story-body">
                L’auditeur obtient une check-list priorisée, justifiée et exportable,
                tout en conservant la traçabilité du raisonnement.
            </div>
        </div>
        """,
        unsafe_allow_html=True,
...
st.markdown('<div class="story-grid-title">Chaîne de valeur du prototype</div>', unsafe_allow_html=True)
...
with flow_1:
    st.markdown(
        ...
        <div class="flow-card">
            ...
            <div class="flow-title">Historique d’audit</div>
            <div class="flow-body">
                Sélection d’une mission source avec constats, non-conformités,
...
with flow_2:
    st.markdown(
        ...
        <div class="flow-card">
            ...
            <div class="flow-title">Score de vigilance</div>
            <div class="flow-body">
                Calcul automatique d’une criticité métier par clause ISO
                et par processus opérationnel.
            </div>
        </div>
        """,
        unsafe_allow_html=True,
...
with flow_3:
    st.markdown(
        ...
        <div class="flow-card">
            ...
            <div class="flow-title">Check-list IA</div>
            <div class="flow-body">
                Génération d’un livrable priorisé selon le signal retenu
                et les règles de préparation définies.
            </div>
        </div>
        """,
        unsafe_allow_html=True,
...
with flow_4:
    st.markdown(
        ...
        <div class="flow-card">
            ...
            <div class="flow-title">Pilotage & export</div>
            <div class="flow-body">
                Visualisation des alertes, traçabilité des décisions,
                sélection des lots et export des résultats.
            </div>
        </div>
        """,
        unsafe_allow_html=True,
...
st.markdown(
    ...
    <div class="demo-banner">
        <div class="demo-banner-title">Mode démonstration opérationnel</div>
        <div class="demo-banner-body">
            Charge les missions dans la barre latérale, choisis un couple
            <b>mission cible / mission historique</b>, puis lance la génération.
            La suite de l’écran restitue automatiquement le lot créé.
        </div>
    </div>
    """,
    unsafe_allow_html=True,
...
st.caption("Prototype PFE – AuditPrep IA | Dashboard Streamlit V4 démonstration métier | Moteur SQL V6")
